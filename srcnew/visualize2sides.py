...
def animate_func(num):
    ...
    #ax[3].plot3D(marker_data[:,num,0], marker_data[:,num,1], marker_data[:,num,2], color='#fa525b', linewidth=8)
    ...
    #ax[3].plot3D(marker_data[:,num,0], marker_data[:,num,1], marker_data[:,num,2], color='#fa525b', linewidth=8)
    ax[3].plot3D(marker_data[0:4,num,0], marker_data[0:4,num,1], marker_data[0:4,num,2], color='#fa525b',antialiased=True, linewidth=12,fillstyle='full')
    ax[3].plot3D(marker_data[4:8,num,0], marker_data[4:8,num,1], marker_data[4:8,num,2], color='#fa525b',antialiased=True, linewidth=12,fillstyle='full')
    ...
    for r in range(7):
        ...
        true_line = ax[1].plot(time[start+shift:end+shift], trial[start+shift:end+shift,r]*0.04-r*2,  color="#dbdbdd", linewidth=1)
...
#####
    ax[2].plot(time[start+shift:end+shift], 2*exp_stim[start+shift:end+shift,:]*0.03+2, color='#fa525b')
    for r in range(7):
        #predicted_line = ax[1].plot(time[start:end], emg_trial[start:end,r]*0.5-r*2,  color="#dbdbdd", linewidth=1)
        true_line = ax[2].plot(time[start+shift:end+shift], trial[start+shift:end+shift,r]*0.04-r*2,  color="#dbdbdd", linewidth=1)
...
###################################################
# Actually plotting
fig, ax = plt.subplots(1, 4 , figsize= (12,9),gridspec_kw={'width_ratios': [2,4,4,5]})
